...
def get_backup_folders():
    ...
    backup_root = os.path.join(root_dir, 'seaco','SORN', 'backup', 'test_single', 'test_dir')
...
def get_result_path(base_num):
    ...
    path = os.path.join(root_dir, 'seaco','SORN', 'backup', 'test_single', 'test_dir', folder, 'common', 'result.h5')
